...
var style_IdiomaWich_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_IdiomaWich_3(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
        ...
        image: new ol.style.Circle({radius: 2.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,0.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.9}), fill: new ol.style.Fill({color: 'rgba(245,245,245,0.95)'})}),
        ...
        var style = rules_IdiomaWich_3(feature, value);
        ;
